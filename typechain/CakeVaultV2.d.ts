...
interface CakeVaultV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "availableVeToken()": FunctionFragment;
    ...
    "deposit(uint256,uint64)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "availableVeToken",
    values?: undefined
  ): string;
  ...
  decodeFunctionResult(functionFragment: "veTokenPid", data: BytesLike): Result;
...
export class CakeVaultV2 extends BaseContract {
  ...
  functions: {
    ...
    availableVeToken(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    veTokenPid(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    "Withdraw(address,uint256,uint256)"(
      ...
      [string, BigNumber, BigNumber],
      { sender: string; amount: BigNumber; withdrawId: BigNumber }
    >;
  ...
  populateTransaction: {
    ...
    availableVeToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    veTokenPid(overrides?: CallOverrides): Promise<PopulatedTransaction>;
